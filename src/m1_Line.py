...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.stuff = 0
        self.originstart = self.start.clone()
        self.originend = self.end.clone()
    ...
    def length(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        return ((self.end.x - self.start.x)**2 + (self.end.y - self.start.y)**2)**.5
    ...
    def midpoint(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        mid = Point((self.end.x + self.start.x)/2, (self.end.y + self.start.y)/2)
        return mid
